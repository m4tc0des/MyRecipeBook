...
namespace UseCases.Tests.Recipe.Recipe;
...
public class RegisterRecipeUseCaseTests
{
    ...
    [Fact]
    public async Task Validate_ShouldThrowException_When_TitleIsEmpty()
    {
        var request = RequestRecipeJsonBuilder.Build();
    ...
    private static RegisterRecipeUseCase CreateUseCase()
    {
        ...
        return new RegisterRecipeUseCase(repository, loggedUser, unitOfWork);
    }
}
